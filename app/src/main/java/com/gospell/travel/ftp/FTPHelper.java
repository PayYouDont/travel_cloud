...
public class FTPHelper implements Serializable {
    ...
    public void upload() throws IOException {
        ...
        if (file.exists () && ftpClient.isConnected ()) {
            ...
            mediaBean.setStatus (FTPService.STATUS_SUCCESS);
            mediaBean.save ();
        }
    }

    public String download(String fileName, String outPath) throws Exception {
        outPath = outPath + File.separatorChar + fileName;
