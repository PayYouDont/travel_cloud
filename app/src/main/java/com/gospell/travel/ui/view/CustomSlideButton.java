...
public class CustomSlideButton extends View {
    ...
    public CustomSlideButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CustomSlideButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setSmallCircleModel() {
        isBigCircle = false;
        strokeLineColor_int = Color.GRAY;
        strokeNoCheckedSolidColor_int = getResources ().getColor (R.color.colorToolBar,null);
        circleChecked_int = Color.WHITE;
        circleNoCheckedColor_int = Color.WHITE;
        invalidate();
    }
    /**
     * 设置大圆模式
    ...
    public void setBigCircleModel() {
        isBigCircle = true;
        strokeLineColor_int = Color.TRANSPARENT;
        strokeCheckedSolidColor_int = getResources ().getColor (R.color.colorToolBar,null);
        strokeNoCheckedSolidColor_int = getResources ().getColor (R.color.colorBackground,null);
        circleChecked_int = Color.WHITE;
        circleNoCheckedColor_int = Color.WHITE;
        invalidate();
    }
